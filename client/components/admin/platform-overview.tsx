  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Transaction Volume Overview</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400">Platform-wide order volume over time</p>
        </div>
